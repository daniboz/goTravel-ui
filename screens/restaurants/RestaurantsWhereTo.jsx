...
// Sample data for popular restaurant destinations
...
const RestaurantsWhereTo = () => {
  ...
  const handleSelectDestination = (destination) => {
    navigation.navigate('RestaurantsPage', { location: `${destination.city}, ${destination.country}` });
  };

  const navigateToRestaurantsPage = () => {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Button
          ...
          onPress={navigateToRestaurantsPage}
          color={COLORS.red}
        />
      </ScrollView>
    </SafeAreaView>
...
export default RestaurantsWhereTo;
